...
import { TrendingUp, TrendingDown, ArrowLeft, Activity, Search, Code, Save, X } from "lucide-react";
...
export default function StockDetail() {
  ...
  const allIndicators = [
    ...
    { id: "macd", name: "MACD", category: "Oscillators", color: "#34d399" },
    ...
    { id: "adx", name: "ADX", category: "Trend", color: "#10b981" },
  ];
  ...
  const generateChartData = (period) => {
    const periods = { "1D": 78, "5D": 390, "1M": 22, "3M": 66, "6M": 132, "1Y": 252, "5Y": 1260 };
  ...
  return (
    <>
      <Navbar />
      <div style={{ marginTop: "70px", background: "linear-gradient(135deg, #0a0e27 0%, #1a1f3a 100%)", minHeight: "100vh", color: "#fff", fontFamily: "'Inter', sans-serif" }}>
        {/* Header */}
        <div style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.1)", background: "rgba(0, 0, 0, 0.3)", padding: "1rem 2rem", position: "sticky", top: "70px", zIndex: 100, backdropFilter: "blur(10px)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", maxWidth: "1800px", margin: "0 auto", flexWrap: "wrap", gap: "1rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
              <button 
                ...
                style={{ background: "none", border: "none", color: "#00ffb3", fontSize: "1.5rem", cursor: "pointer", display: "flex", alignItems: "center", padding: "0.5rem", transition: "transform 0.2s" }}
          ...
          <div style={{ background: "rgba(0, 0, 0, 0.5)", borderBottom: "1px solid rgba(255, 255, 255, 0.1)", padding: "1.5rem 2rem", maxHeight: "70vh", overflowY: "auto" }}>
            <div style={{ maxWidth: "1800px", margin: "0 auto" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem", flexWrap: "wrap", gap: "1rem" }}>
                <div style={{ fontSize: "1.1rem", color: "#fff", fontWeight: "700" }}>Technical Indicators</div>
        ...
        {/* Pine Script Editor - PERFECTLY SIZED */}
        {showPineEditor && (
          <div style={{ position: "fixed", inset: 0, background: "rgba(0, 0, 0, 0.85)", zIndex: 2000, display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem" }}>
            <div style={{ 
              ...
              boxShadow: "0 20px 60px rgba(0, 255, 179, 0.2)"
            }}>
              {/* Header - Fixed Height */}
              <div style={{ 
                padding: "1.5rem 2rem", 
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                  <Code size={28} style={{ color: "#a78bfa" }} />
                  <div>
                    <div style={{ fontSize: "1.4rem", fontWeight: "700", color: "#fff" }}>Pine Script Editor</div>
                    <div style={{ fontSize: "0.9rem", color: "#a0a9b8", marginTop: "0.25rem" }}>Create your custom indicator</div>
                  </div>
                </div>
                <button 
              ...
              <div style={{ 
                ...
                <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
                  <div style={{ fontSize: "1rem", color: "#00ffb3", marginBottom: "0.75rem", fontWeight: "600" }}>Pine Script Code:</div>
                  <textarea
                    value={pineScript}
              ...
              <div style={{ 
                ...
                <button
                  ...
                  onMouseLeave={(e) => {
                    ...
                    e.currentTarget.style.color = "#a0a9b8";
                  }}
                >
                  Cancel
                </button>
                <button
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = "0 6px 25px rgba(167, 139, 250, 0.4)";
                  }}
                  onMouseLeave={(e) => {
                ...
                <div style={{ marginBottom: "1.25rem" }}>
                  ...
                  <div style={{ display: "flex", gap: "0.5rem" }}>
                    <button 
                      ...
                      style={{ width: "40px", height: "40px", background: "rgba(255, 255, 255, 0.1)", border: "1px solid rgba(255, 255, 255, 0.2)", borderRadius: "6px", color: "#00ffb3", cursor: "pointer", fontWeight: "700", fontSize: "1.2rem" }}
                    >
                      −
                    </button>
                    <input 
                      ...
                      style={{ flex: 1, background: "rgba(255, 255, 255, 0.1)", border: "1px solid rgba(255, 255, 255, 0.2)", borderRadius: "6px", color: "#fff", textAlign: "center", fontWeight: "600", padding: "0.5rem", fontSize: "1rem" }} 
                    />
                    <button 
                ...
                {priceType === 'LIMIT' && (
                  <div style={{ marginBottom: "1.25rem" }}>
                    ...
                    <input 
                      ...
                      style={{ width: "100%", padding: "0.75rem", background: "rgba(255, 255, 255, 0.1)", border: "1px solid rgba(255, 255, 255, 0.2)", borderRadius: "6px", color: "#fff", fontWeight: "600", fontSize: "1rem" }} 
                    />
                  </div>
                )}
            ...
            <div style={{ background: "rgba(255, 255, 255, 0.05)", border: "1px solid rgba(255, 255, 255, 0.1)", borderRadius: "12px", padding: "1.5rem" }}>
              ...
              {[0, 1, 2, 3, 4].map(i => (
                <div key={i} style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.5rem", fontSize: "0.85rem" }}>
                  <div style={{ flex: 1, textAlign: "left", color: "#00ffb3" }}>₹{(stock.price - (i + 1) * 0.5).toFixed(2)}</div>
                  <div style={{ flex: 1, textAlign: "center", color: "#a0a9b8" }}>{Math.floor(Math.random() * 500 + 100)}</div>
                  <div style={{ flex: 1, textAlign: "center", color: "#a0a9b8" }}>{Math.floor(Math.random() * 500 + 100)}</div>
                  <div style={{ flex: 1, textAlign: "right", color: "#ff4757" }}>₹{(stock.price + (i + 1) * 0.5).toFixed(2)}</div>
                </div>
              ))}
            </div>
          </div>
