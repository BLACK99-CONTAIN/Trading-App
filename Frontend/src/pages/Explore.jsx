...
export default function Explore() {
  ...
  const fetchMarketData = async () => {
    try {
      ...
      setMarketData({
        trending: [
          { symbol: "RELIANCE", name: "Reliance Industries", price: 2456.75, change: 2.34, changePercent: 0.95, volume: "2.1M" },
        ...
        losers: [
          ...
          { symbol: "MARUTI", name: "Maruti Suzuki India", price: 10234.80, change: -287.90, changePercent: -2.74, volume: "567K" }
        ],
        news: [
            ...
            {marketData.categories.map((category, index) => (
              <div key={index} className="category-card">
                ...
                <div className="category-info">
                  ...
                  <div className={`category-growth ${category.growth.startsWith('+') ? 'positive' : 'negative'}`}>
                    {category.growth}
                  </div>
                </div>
              </div>
